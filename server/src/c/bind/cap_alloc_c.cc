...
#include "/home/timo/github/l4re/l4/pkg/l4re-c-examples/server/src/c/bind/cap_alloc_c.h"
...
l4_cap_idx_t l4_re_util_counting_cap_alloc_counter_alloc(struct l4_re_util_counting_cap_alloc_counter * __self)
{
  ...
  ___self = cppbind::c::struct_cast<L4Re::Util::Counting_cap_alloc<L4Re::Util::Counter<unsigned char>>>(__self);
