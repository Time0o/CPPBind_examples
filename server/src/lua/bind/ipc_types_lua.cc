...
int l4_ipc_cap_l4_re_dataspace_new_1(lua_State *L)
{
  if (lua_gettop(L) != 1)
...
int l4_ipc_cap_l4_re_dataspace_new_2(lua_State *L)
{
  if (lua_gettop(L) != 0)
...
int l4_ipc_cap_l4_re_dataspace_new_3(lua_State *L)
{
  if (lua_gettop(L) != 2)
...
int l4_ipc_cap_l4_re_dataspace_from_ci(lua_State *L)
{
  if (lua_gettop(L) != 1)
    return luaL_error(L, "function expects 1 arguments");
...
int l4_ipc_cap_l4_re_dataspace_cap(lua_State *L)
{
  if (lua_gettop(L) != 1)
    return luaL_error(L, "function expects 1 arguments");
  ...
  luaL_checktype(L, 1, LUA_TUSERDATA);
  ___self = cppbind::type_info::typed_pointer_cast<const L4::Ipc::Cap<L4Re::Dataspace>>(*static_cast<void **>(lua_touserdata(L, 1)));
...
int l4_ipc_cap_l4_re_dataspace_rights(lua_State *L)
{
  if (lua_gettop(L) != 1)
    return luaL_error(L, "function expects 1 arguments");
...
int l4_ipc_cap_l4_re_dataspace_is_valid(lua_State *L)
{
  if (lua_gettop(L) != 1)
    return luaL_error(L, "function expects 1 arguments");
...
int l4_ipc_cap_l4_re_dataspace_copy(lua_State *L)
{
  if (lua_gettop(L) != 1)
    return luaL_error(L, "function expects 1 arguments");
  ...
  luaL_checktype(L, 1, LUA_TUSERDATA);
  __1 = cppbind::type_info::typed_pointer_cast<const L4::Ipc::Cap<L4Re::Dataspace>>(*static_cast<void **>(lua_touserdata(L, 1)));
...
int l4_ipc_cap_l4_re_dataspace_move(lua_State *L)
{
  if (lua_gettop(L) != 1)
    return luaL_error(L, "function expects 1 arguments");
  ...
  luaL_checktype(L, 1, LUA_TUSERDATA);
  __1 = cppbind::type_info::typed_pointer_cast<L4::Ipc::Cap<L4Re::Dataspace>>(*static_cast<void **>(lua_touserdata(L, 1)));
...
int l4_ipc_cap_l4_re_dataspace_new_l4_re_dataspace(lua_State *L)
{
  if (lua_gettop(L) != 1)
    return luaL_error(L, "function expects 1 arguments");
  ...
  luaL_checktype(L, 1, LUA_TUSERDATA);
  _o = cppbind::type_info::typed_pointer_cast<const L4::Ipc::Cap<L4Re::Dataspace>>(*static_cast<void **>(lua_touserdata(L, 1)));
...
void _register(lua_State *L)
{
...

  {
    static luaL_Reg const _functions[] = {
      {"new_1", l4_ipc_cap_l4_re_dataspace_new_1},
      {"new_2", l4_ipc_cap_l4_re_dataspace_new_2},
      {"new_3", l4_ipc_cap_l4_re_dataspace_new_3},
      {"from_ci", l4_ipc_cap_l4_re_dataspace_from_ci},
      {"copy", l4_ipc_cap_l4_re_dataspace_copy},
      {"move", l4_ipc_cap_l4_re_dataspace_move},
      {"new_l4_re_dataspace", l4_ipc_cap_l4_re_dataspace_new_l4_re_dataspace},
      {nullptr, nullptr}
    };
...
void _createmetatables(lua_State *L)
{
  cppbind::lua::createmetatable(L, "METATABLE__ZTSN2L43Ipc3CapIN4L4Re9DataspaceEEE",
    {
      {"from_ci", l4_ipc_cap_l4_re_dataspace_from_ci},
      {"cap", l4_ipc_cap_l4_re_dataspace_cap},
      {"rights", l4_ipc_cap_l4_re_dataspace_rights},
      {"is_valid", l4_ipc_cap_l4_re_dataspace_is_valid},
